...
> **Welcome to Product-Track Week 3, Task 5!**
...
| `src/formatConverter.js` | Main source code - **has bugs to fix** |
| `src/schemaMapper.js` | Supporting code - **may also have bugs** |
| `tests/formatConverter.test.js` | Test file - **add your tests here** |
