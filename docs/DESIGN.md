# Architecture Decision Record - CSV and JSON data format converter service

**Date:**
**Status:** Accepted
**Authors:** Raj Kapoor, Ananya

## Decision

Implement CSV and JSON data format converter service using industry-standard patterns appropriate for nodejs and our platform requirements.
